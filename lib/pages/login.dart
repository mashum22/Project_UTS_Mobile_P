...
import 'package:projectmashum/pages/dashboard.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              // Meningkatkan ukuran Lottie
              Lottie.asset('assets/lotties/login1.json', height: 50), // Ukuran baru
              SizedBox(height: 20),
              Text(
                'Selamat Datang',
                style: TextStyle(
